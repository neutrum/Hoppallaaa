...
function smarty_function_ci_db_session($params, &$smarty)
{
        ...
        $_name = isset($params['name']) ? $smarty->_dequote($params['name']) : '';
        $_type = isset($params['type']) ? $smarty->_dequote($params['type']) : 'user';
        $_assign = isset($params['assign']) ? $smarty->_dequote($params['assign']) : $_name;
